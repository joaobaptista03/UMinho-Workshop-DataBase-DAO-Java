...
public class AdministradorUI {
    ...
    private boolean adicionarFuncionario(OficinaDAOFacade oficinaDAO) throws IOException {
        ...
        Funcionario novoFuncionario = new Funcionario(nrFuncionarios, nome, email, password, nrCartao, posto, horaEntrada, horaSaida, new ArrayList<>(), competencias_list, administradorID);
